          ...
          <div className="space-y-4">
            ...
            >
              ...
              <input
                ...
                autoComplete="name"
                required
                className={`form-input glass-morphism ${errors.name ? 'border-red-500 focus:border-red-500' : ''}`}
            ...
            >
              ...
              <input
                ...
                autoComplete="email"
                required
                className={`form-input glass-morphism ${errors.email ? 'border-red-500 focus:border-red-500' : ''}`}
            ...
            >
              ...
              <input
                ...
                required
                className={`form-input glass-morphism ${errors.password ? 'border-red-500 focus:border-red-500' : ''}`}
            ...
            >
              ...
              <input
                ...
                autoComplete="new-password"
                required
                className={`form-input glass-morphism ${errors.confirmPassword ? 'border-red-500 focus:border-red-500' : ''}`}
