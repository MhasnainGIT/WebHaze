  ...
  const features = [
    {
      ...
      description: "SSD storage and CDN for maximum speed"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: "Secure",
      description: "Free SSL certificates and daily backups"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: "Scalable",
      description: "Grow your resources as your business grows"
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
