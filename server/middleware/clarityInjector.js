...
function getClaritySnippet(clarityId) {
  if (!clarityId) return '';
  // Minimal Clarity snippet (official snippet may change; this is a safe placeholder)
  return `<!-- Clarity -->\n<script type="text/javascript">(function(c,l,a,r,i,t,y){c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/${clarityId}";y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);})(window,document,"clarity","script");</script>\n<!-- End Clarity -->`;
}
